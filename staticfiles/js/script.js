...
document.addEventListener('DOMContentLoaded', (event) => {
    function moveButterfly() {
        ...
        const butterfly = document.querySelector('.studentJourney .butterfly'); // Assuming the butterfly has a class 'butterfly'
        const steps = document.querySelectorAll('.studentJourney > div'); // Assuming each step is a direct child div of .studentJourney
